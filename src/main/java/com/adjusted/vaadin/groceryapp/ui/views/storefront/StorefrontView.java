package com.adjusted.vaadin.groceryapp.ui.views.storefront;
...
import com.adjusted.vaadin.groceryapp.ui.components.SearchBar;
import com.adjusted.vaadin.groceryapp.ui.utils.BakeryConst;
import com.adjusted.vaadin.groceryapp.ui.views.EntityView;
import com.adjusted.vaadin.groceryapp.ui.views.orderedit.OrderDetails;
...
public class StorefrontView extends PolymerTemplate<TemplateModel>
	...
	public void beforeEnter(BeforeEnterEvent event) {
		Optional<Long> orderId = event.getRouteParameters().getLong(BakeryConst.ORDER_ID);
		if (orderId.isPresent()) {
			boolean isEditView = BakeryConst.EDIT_SEGMENT.equals(getLastSegment(event));
